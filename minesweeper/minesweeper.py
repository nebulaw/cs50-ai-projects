...
class Sentence():
    ...
    def known_mines(self):
        ...
        """
        return self.cells.copy() if self.count == len(self.cells) and self.count != 0 else set()
